  ...
  return (
    <section className="bg-warm-surface relative overflow-hidden py-20 lg:py-28">
      ...
      <div className="container relative mx-auto px-4">
        ...
        {/* CTA Cards */}
        <StaggerReveal className="mx-auto grid max-w-6xl gap-6 md:grid-cols-2 lg:grid-cols-4">
          {options.map((option, index) => {
            ...
            return (
              <Reveal key={index} direction="scale" inherit>
                <div className="bg-warm-card group relative flex h-full flex-col overflow-hidden rounded-2xl border border-primary/10 p-8 shadow-[0_18px_40px_rgba(15,23,42,0.04)] transition-all duration-300 hover:-translate-y-2 hover:border-primary/45 hover:bg-white/80 hover:shadow-[0_24px_60px_rgba(234,88,12,0.12)]">
        ...
        {/* Additional Info */}
        <Reveal className="mt-16 flex justify-end" delay={0.15}>
