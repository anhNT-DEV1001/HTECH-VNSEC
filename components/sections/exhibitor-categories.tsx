              ...
              return (
                ...
                >
                  ...
                  <div className="flex min-h-[104px] flex-1 flex-col pt-4">
                    ...
                    <div className="mt-auto flex items-center pt-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary/80 transition-colors group-hover:text-primary">
                      {t("card.hover")}
              ...
              <div className="bg-white px-6 py-6 sm:px-8 sm:py-8">
                ...
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <span className="text-xs font-semibold uppercase tracking-[0.2em] text-primary/70">
                    {locale === "vi" ? "Lĩnh vực triển lãm" : "Exhibition Category"}
                  </span>
                </div>
